...
SETTINGS_PATH = os.path.dirname(os.path.dirname(__file__)) #so that django will look
                                                           # for templates at gien directory
...
#This settings  os.path.join(SETTINGS_PATH, 'templates'),
#means that django will look at the templates from templates/ directory under your project.
#variable SETTINGS_PATH had to be defined 
